...
using Book.EntityFrameworkCore.Seed;
...
namespace Book.EntityFrameworkCore
{
    ...
    public class BookEntityFrameworkModule : AbpModule
    {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(BookEntityFrameworkModule).GetAssembly());
        }
